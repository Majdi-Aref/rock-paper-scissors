...
- ## 2. 1. Logo
  ...
  - Please find below images of the logo on differenct screen sizes.
...
- ## 2. 4. Outcome Section
  ...
  - Underneatah the fianl result are a player's score and the computer's score, which specify how many rounds a player wins and how many rounds the computer wins.
  ...
  - As soon as a user or the computer has won 10 rounds, the final result's paragraph will broadcast that, articulate the winner of a game, and stir a user up to click on the "Reset & Play Again" button, which is both found and accetuated at the bottom of the outcome section, to have a go at a new game.
...
- ## 7. 2. style.css File
  ...
  - I took 2 screenshots of the CSS validation result, please have a look them lower down.
...
- Appling media queries, I developed the Rock Paper Scissors' website to fit Laptops', tabs', and smartphones' screen sizes.
- The browser that I put to use is Google Chrome.
- Please have a look a the images below; they successively show how the game's page simulates on smartphones, tabs, and laptops.
...
- ## 11. 1. Via Codeanywhere
  ...
  - Open Codeanywhere's workspaces, then create a new workspace for the new repository that you created on Github; Codeanywhere will save the workspace that you created.
  - Open the Codeanywhere's workspace that you just created.
  ...
  - In that small window, click on "Browser"; this opens your Github's repository through your Codeanywhere's workspace in a browser in a new tab.
  - Press at that same time "Control + Shift + R" to refresh your browser.
  - Press at the same time "Control + S" to save the code you create in Codeanywhere's worksace; this will automatically save it in your applicable file in your Codeanywhere's workspaces.
  - Type in the Codeanywhere's terminal the command: "git add ." to add your project's code that you have created during a working session of yours to your Codeanywhere's workspace.
  - Type in the Codeanywhere's terminal the command: "git commit -m 'what code, styling, documentation, or corrections you have made or done in your Codoeanywhere's workspace in just a few words'" to commit your project's code to your Codeanywhere's workspace.
  - Type in the Codeanywhere's terminal the command: "git push" to push and save your project's code in your Github's repository.
